...
public class FoldingLaunchConfigType extends AbstractCLaunchDelegate {
	...
	private void testPrint(ILaunchConfiguration configuration) throws CoreException {
		System.out.println(
		...
		System.out.println(
				configuration.getAttribute
				(ICDTLaunchConfigurationConstants.ATTR_PLATFORM, ""));
	}
}
